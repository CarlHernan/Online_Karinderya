<x-layout>
    <div class="min-h-screen w-full overflow-x-hidden flex flex-col" style="background-color: #dddbd9;">
        <!-- Hero -->
        <section class="relative flex flex-col items-center justify-center text-center gap-6 px-4 py-12 md:py-16 lg:py-20">
            <h1 class="text-emerald-900 font-bold font-merriweather text-4xl md:text-5xl lg:text-6xl max-w-4xl">About PingganPH</h1>
            <!-- Responsive hero images -->
            <div class="w-full max-w-6xl mx-auto hidden lg:grid grid-cols-3 gap-8">
        ...
        <section class="py-10 md:py-12 lg:py-16 px-4 md:px-8 lg:px-12 flex flex-col w-full mb-8 md:mb-12">
            <div class="w-full space-y-12 md:space-y-16 lg:space-y-24 max-w-6xl mx-auto">
                <!-- intro -->
                <section class="text-center">
                    <h2 class="font-merriweather text-3xl md:text-4xl font-bold text-gray-900 leading-tight mb-4">Who We Are</h2>
                    <p class="font-poppins text-gray-700 text-base md:text-lg max-w-3xl mx-auto mb-6 md:mb-8 lg:mb-10">PingganPH brings quality homemade Filipino meals straight to your hands. What started as a humble Karinderya in Kabacan is now online—serving you your favorite ulam, anytime, anywhere.</p>

                <!-- mission statement -->
                    <h2 class="font-merriweather text-3xl md:text-4xl font-bold text-gray-900 leading-tight mb-4">Mission Statement</h2>
                    <p class="font-poppins text-gray-700 text-base md:text-lg max-w-3xl mx-auto mb-6 md:mb-8 lg:mb-10">Our mission is to make homestyle meals accessible to everyone, combining tradition with the convenience of modern technology.</p>
                </section>

                <!-- our story  -->
                <section class="text-center">
                    <h2 class="font-merriweather text-3xl md:text-4xl font-bold text-gray-900 leading-tight mb-4">Our Story</h2>
                    <div class="space-y-5 text-base md:text-lg font-poppins text-gray-700 max-w-3xl mx-auto mb-4 md:mb-6">
                ...
                <section class="space-y-8 w-full mb-6 md:mb-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto">
                        <!-- what makes us different -->
                        <section class="flex-1 bg-amber-500 p-5 md:p-6 lg:p-8 rounded-lg shadow-md min-h-[240px] flex flex-col">
                ...
                <!-- community & customers -->
                <section class="text-center bg-amber-500 p-6 md:p-8 lg:p-12 rounded-lg shadow-md max-w-4xl mx-auto mb-2 md:mb-4">
                ...
                <!-- CTA -->
                <div class="pt-2 md:pt-4 flex justify-center mb-2">

<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('menu')" :active="request()->routeIs('menu')" @click="open=false">
                {{ __('Menu') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('about')" :active="request()->routeIs('about')" @click="open=false">
                {{ __('About') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('orders')" :active="request()->routeIs('orders')" @click="open=false">
                {{ __('My Orders') }}
            </x-responsive-nav-link>
        </div>
